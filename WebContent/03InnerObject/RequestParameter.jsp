...
<body>
   ...
   */
   ...
   /*
   radio는 항목은 여러개 선언되더라도, 선택 가능한 항목이 1개이기 때문에
   getParameter()를 통해 폼값을 받을 수 있다.
   	체크박스는 여러항목을 선택하기때문에 안됨.
   */
   ...
   */
   ...
   <%
   /*
   getParameterNames() : 폼값의 이름을 한꺼번에 받을때 사용하는 메소드로
   				반환타입은 Enumeration 형이다.
   ...
   */
	   ...
	   while(names.hasMoreElements()){
		   ...
		   if(paramName.equals("sex")|| paramName.equals("favorite")){
			   ...
			   System.out.println("getParameterValues로 읽기");
