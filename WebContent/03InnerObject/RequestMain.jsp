...
<body>
	...
	*/
	...
	<form method="post" name="regFrm" action="RequestParameter.jsp"
		...
		<br />
		자기소개:
		<textarea name="self_intro" cols="30" rows="10">엄한 아버지와 자애로운 어머니 밑에서 자라며 웅앵웅</textarea>
		<!-- textarea는 태그와 태그 사이에 컨텐츠가 들어가므로 정렬을 위해
		줄바꿈을 사용하게 되면 필요없는 공백이 포함될 수 있으므로 주의해야 한다. 
		textarea 안에서 br태그를 사용해도 태그가 그대로 나온다.-->
		<br />
		<input type="submit" value="POST방식" />
